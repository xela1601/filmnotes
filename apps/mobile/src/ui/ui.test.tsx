...
describe('ui kit', () => {
  ...
  it('renders TextField and reports changes', () => {
    ...
    render(
      <TextField label="Notizen" value="alt" onChangeText={onChangeText} testID="notes" />,
    );
  ...
  describe('IssueList', () => {
    ...
    it('renders translated issue texts', () => {
      ...
      expect(screen.getByTestId('issues-handheld_shake_risk')).toHaveTextContent('1/60', { exact: false });
