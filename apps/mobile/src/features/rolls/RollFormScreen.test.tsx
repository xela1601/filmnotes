...
describe('RollForm', () => {
  ...
  it('starts with the seeded camera and no film', () => {
    ...
    expect(screen.getByTestId(`roll-form-camera-option-${MINOLTA_7000}`).props.accessibilityState)
  ...
  it('fills the ISO from the chosen film stock', () => {
    ...
    expect(screen.getByTestId('roll-form-film-stock-open')).toHaveTextContent('Kodak Gold 200 · ISO 200');
  });
