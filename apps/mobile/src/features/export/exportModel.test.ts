...
import { captionFor, exportInputFor, isWordPressConfigured, wordPressConfigFor } from './exportModel';
import type { AppState } from '../../store/store';
import { createAppStore, DEFAULT_SETTINGS, type Settings } from '../../store/store';
import {
  makeCamera,
  makeFilmStock,
  makeFilter,
...
describe('captionFor', () => {
  it('builds the default caption from the frame and its equipment', () => {
    ...
    expect(caption).toContain('Kodak Gold 200 · Minolta 7000 AF · Minolta AF Zoom 35-70mm f/4 @ 50mm');
